...
(2) It extends to the whole of India.
   (3) It shall come into force on such date1as the Central Government may, by notification in the Official Gazette, appoint; and different dates may be appointed for different State and any reference in this Act to the commencement of this Act shall, in relation to a State, be construed as a reference to the coming into force of this Act in that State.
...
vehicle between one terminus and another;
      2[(39) "semi-trailer" means a vehicle not mechanically propelled (other than a trailer), which is intended to be connected to a motor vehicle and which is so constructed that a portion of it issuper- imposed on, and a part of whose weight is borne by, thatmotor vehicle;]
...
for the issue to him of a learner's licence.
   ...
   (3) Every application under sub-section (1) shall be accompanied by a medical certificate in such form as may be prescribed by the Central Government and signed by such registered medical practitioner, as the State Government or any person authorised in this behalf by the State Government may, by notification in the Official Gazette, appoint for this purpose:
      4[Provided that no such medical certificate is required for licence to drive a vehicle other than a transport vehicle.]
...
Provided that no such test shall be necessary where the applicant produces proof to show that-
   ...
   (4) Where the application is for a licence to drive a transport vehicle, no such authorisation shall be granted to any applicant unless he possesses such minimum educational qualification as may be prescribed by the Central Government and a driving certificate issued by a school or establishment referred to in section 12.
      1[(5) Where the applicant does not  pass the test; he may be permitted to re-appear for the test after a period of seven days:
...
it may, for reasons to be recorded tin writing, make an order refusing to issue a driving licence to such person and any person aggrieved by 586 an order made by a licensing authority under this sub-section may, within thirty days of the receipt of the order, appeal to the prescribed authority.
...
1***
2[Provided that in the case of licence to drive a transport vehicle carrying goods of dangerous
or hazardous nature be effective for a period of one year and renewal thereof shall be subject to the condition that  the driver  undergoes  one  day  refresher course of the prescribed syllabus; and;]
...
3. Subs. by s. 9, ibid., for "forty years" (w.e.f. 14-11-1994).
      ...
      1[(ii) if the person referred to in sub-clause (i), has attained the age of fifty years on the date of issue or as the case may be. renewal thereof, be effective, on payment of such fee as may be prescribed, for a period of five years from the date of such issue or renewal:]
   ...
   17. Orders refusing or revoking driving licences and appeals therefrom-(1) Where a licensing authority refuses to issue any learner's licence or to issue or renew, or revokes, any driving licence, or

1. Subs. by Act 54 of 1994, s. 9, for sub-clause (ii) (w.e.f. 14-11-1994).

refuses to add a class or description of motor vehicle to any driving licence, it shall do so by an order communicated to the applicant or the holder, as the case may be, giving the reasons in writing for such refusal or revocation.
...
(c) who is convicted of an offence punishable under section 192:
   ...
   21. Suspension of driving licence in certain cases.-(1) Where, in relation to a person who had been previously convicted of an offence punishable under section 184, a case is registered by a police officer on the allegation that such person has, by such dangerous driving as is referred to in the said section 184, of any class or description of motor vehicle caused the death of, or grievous hurt to, one or

more persons, the driving licence held by such person shall in relation to such class or description of motor vehicle become suspended-
...
27. Power of Central Government to make rules.-The Central Government may make rules- 2[(a) specifications relating to e-cart and e-rickshaw under sub-section (2) of section 2A;] 3[(aa)] regarding conditions referred to in sub-section (2) of section 3;
...
(j) the manner in which the State Register of Driving Licences shall be maintained under section
26;
...
(l) any other matter which is to be, or may be, prescribed.
   ...
   43. Temporary registration.-(1) Notwithstanding anything contained in section 40 the owner of a motor vehicle may apply to any registering authority or other prescribed authority to have the vehicle
...
4. Subs. by s. 14, ibid., for "under section 47, make an application" (w.e.f. 14-11-1994).

to as the financier) for the issue of a no objection certificate (hereafter in this section referred to as the certificate).
...
(f) change of address,
shall communicate1[by registered post acknowledgment due] to the financier that such entry has been made.
      2[(11) A registering authority registering the new vehicle, or issuing the duplicate certificate of registration or a no objectioncertificate or a temporary certificate of registration, or issuing or renewing, a fitness certificate or substituting entries relating toanother motor vehicle in the permit, shall intimate the financierof such transaction.
...
2. Subs. by s.14, ibid., for sub-section (11) (w.e.f. 14-11-1994).
   ...
   (a) is in such a condition that its use in a public place would constitute a danger to the public, or that it fails to comply with the requirements of this Act or of the rules made thereunder, or
       (b) has been, or is being, used for hire or reward without a valid permit for being used as such, the authority may, after giving the owner an opportunity of making any representation he may wish to
make (by sending to the owner a notice by registered post acknowledgement due at his address entered in the certificate of registration), for reasons to be recorded in writing, suspend the certificate of registration of the vehicle-
...
1. Subs. by Act 27 of 2000, s. 2, for section 52 (w.e.f. 11-8-2000).
   ...
   (7) A registering authority making an order of cancellation under section 54 or under this section shall, if it is the original registering authority, cancel the certificate of registration and the entry relating to the vehicle in its records, and, if it is not the original registering authority, forward the certificate of

registration to that authority, and that authority shall cancel the certificate of registration and the entry relating to the motor vehicle in its records.
   ...
   57. Appeals.-2[(1) Any person aggrieved by an order of the registering authority under section 41, 42, 43, 45, 47, 48, 49, 50, 52, 53, 55 or 56 may, within thirty days of the date on which he has received notice of such order, appeal against the order to the prescribed authority.]
...
1. Ins. by Act 54 of 1994, s. 16 (w.e.f. 14-11-1994).
2. Subs. by s.17, ibid., for sub-section (1) (w.e.f. 14-11-1994).
3. Subs. by s. 18, ibid., for "maximum safe laden weight" (w.e.f. 14-11-1994).
...
Provided further that the State Government may,-
   (i) where it considers necessary or expedient so to do, constitute the State Transport Authority or a Regional Transport Authority for any region so as to consist of only one member who shall be an


1. The proviso omitted by Act 39 of 2001, s. 3 (w.e.f. 27-9-2001).

official with judicial experience or experience as an appellate or a revisional authority or as an adjudicating authority competent to pass any order or take any decision under any law;
...
(vi) ex-servicemen.
   75. Scheme for renting of motor cabs.-(1) The Central Government may, by notification in the Official Gazette, make a scheme for the purpose of regulating the business of renting of 1[motor cabs or motor cycles to persons desiring to drive either by themselves or through drivers, motor cabs or motor cycles] for their own use and for matters connected therewith.
...
1. Subs. by Act 54 of 1994, s. 25, for "Regional Transport Authority" (w.e.f. 14-11-1994).
   ...
   81. Duration and renewal of permits.-(1) A permit other than a temporary permit issued under section 87 or a special permit issued under sub-section (8) of section 88 shall be effective 2[from the date of issuance or renewal thereof] for a period of five years:
...
(ii) making unauthorised trips:
   ...
   (5) Where a permit has been renewed under this section after the expiry of the period thereof, such renewal shall have effect from the date of such expiry irrespective of whether or not a temporary permit


1. Subs. by Act 54 of 1994, s. 25, for "Regional Transport Authority" (w.e.f. 14-11-1994).
2. Subs. by s. 26, ibid., for "without renewal" (w.e.f. 14-11-1994).

has been granted under clause (d) of section 87, and where a temporary permit has been granted, the fee paid in respect of such temporary permit shall be refunded.
...
(c) to meet a particular temporary need, or
   ...
   (i) no permit could be issued under section 72 or section 74 or section 76 or section 79 in respect of that route or area by reason of an order of a court or other competent authority restraining the issue

of the same, for a period not exceeding the period for which the issue of the permit has been so restrained; or
...
(iii) such other conditions as may be prescribed by the Central Government.
   (12) Notwithstanding anything contained in sub-section (1), but, subject to the rules that may be made by the Central Government under sub-section (14), the appropriate authority may, for the purpose of
...
(f) aggrieved by the refusal to grant permission under section 83, or
   (g) aggrieved by any other order which may be prescribed, may, within the prescribed time and in the prescribed manner, appeal to the State Transport Appellate Tribunal constituted under sub-section (2), who shall, after giving such person and the original authority an opportunity of being heard, give a decision thereon which shall be final.
      3[(2) The State Government shall constitute such number of Transport Appellate Tribunals as it thinks fit and each such Tribunal shall consist of a judicial officer who is not below the rank of a


1. Subs. by Act 54 of 1994, s. 27, for "and 89" (w.e.f. 14-11-1994).
2. Sub-section (13) omitted by s. 27, ibid. (w.e.f. 14-11-1994).
3. Subs. by s. 28, ibid., for sub-section (2) (w.e.f. 14-11-1994).
...
(ii) reduce the number of vehicles authorised to be used under the permit;
   ...
   (2) Notwithstanding anything contained in sub-section (1), no compensation shall be payable on account of the cancellation of any existing permit or any modification of the terms thereof, when a permit

for an alternative route or area in lieu thereof has been offered by the State Transport Authority or the Regional Transport Authority, as the case may be and accepted by the holder of the permit.
...
(b) for part of a month not exceeding fifteen days of the
    unexpired period of the permit	One hundred rupees: Provided that the amount of compensation shall, in no case, be less than four hundred rupees.
...
3. Ins. by s. 32, ibid. (w.e.f. 14-11-1994).
...
2. Subs. by s. 35, ibid., for certain words and figures (w.e.f. 14-11-1994).
   ...
   (2) In this section "mandatory traffic sign" means a traffic sign included in Part A of the Schedule, or any traffic sign of similar form (that is to say, consisting of or including a circular disc diplaying a device,

1. Subs. by Act 54 of 1994, s. 36, for "the Schedule" (w.e.f. 14-11-1994).

word or figure and having a red ground or border) placed or erected for the purpose of regulating motor vehicle traffic under sub-section (1) of section 116.
...
(b) "ticket" includes a single ticket, a return ticket or a season ticket.
   ...
   127. Removal of motor vehicles abandoned or left unattended on a public place.-1[(1) Where any motor vehicle is abandoned, or left unattended, on a public place for ten hours or more or is parked in


1. Subs. by Act 54 of 1994, s. 37, for sub-section (1) (w.e.f. 14-11-1994).

a place where parking is legally prohibited, its removal by a towing service or its immobilisations by any means including wheel clamping may be authorised by a police officer in uniform having jurisdiction.]
...
4. Subs. by s. 39, ibid., for sub-section (3) (w.e.f. 14-11-1994).
   ...
   132. Duty of driver to stop in certain cases.-(1) The driver of a motor vehicle shall cause the vehicle to stop and remain stationary so long as 1[may for such reasonable time as may be necessary, but not exceeding twenty-four hours]-
...
4. Subs. by s. 41, ibid., for "and if necessary, convey him to the nearest hospital" (w.e.f. 14-11-1994).

render medical aid or treatment without waiting for any procedural formalities], unless the injured person or his guardian, in case he is a minor, desires otherwise;
   (b) give on demand by a police officer any information required by him, or, if no police officer is present, report the circumstances of the occurrence, including the circumstances, if any, for not taking reasonable steps to secure medical attention as required under clause (a), at the nearest police station as soon as possible, and in any case within twenty-four hours of the occurrence.
      1[(c) give the following information in writing to the insurer, who has issued the certificates of insurance, about the occurrence of the accident, namely:-
...
1. Ins. by Act 54 of 1994, s. 41 (w.e.f. 14-11-1994).
2. Subs. by s. 42, ibid., for "without unnecessary delay" (w.e.f. 14-11-1994).
...
(d) without side-car being attached where the vehicle is a motor cycle; or
   ...
   (3) Where any such judgment as is referred to in sub-section (1) is obtained from a Court in a reciprocating country and in the case of a foreign judgment is, by virtue of the provisions of section 13 of the Code of Civil Procedure, 1908 (5 of 1908) conclusive as to any matter adjudicated upon by it, the insurer (being an insurer registered under the Insurance Act, 1938 (4 of 1938) and whether or not he is registered under the corresponding law of the reciprocating country) shall be liable to the person entitled


1. Ins. by Act 54 of 1994, s. 47 (w.e.f. 14-11-1994).

to the benefit of the decree in the manner and to the extent specified in sub-section (1), as if the judgment were given by a Court in India:
...
notwithstanding anything to the contrary in any provision of law, be transferred to and vest in the person to whom the debt is owing.
   ...
   (2) The transferee shall apply within fourteen days from the date of transfer in the prescribed form to the insurer for making necessary changes in regard to the fact of transfer in the certificate of insurance


1. Ins. by Act 54 of 1994, s. 48 (w.e.f. 14-11-1994).

and the policy described in the certificate in his favour and the insurer shall make the necessary changes in the certificate and the policy of insurance in regard to the transfer of insurance.
...
such Tribunal may make an order for the payment, by the party who is guilty of mis-representation or by whom such claim or defence has been put forward of special costs by way of compensation to the insurer or, as the case may be, to the party against whom such claim or defence has been put forward.
   ...
   174. Recovery of money from insurer as arrear of land revenue.-Where any amount is due from any person under an award, the Claims Tribunal may, on an application made to it by the person entitled

to the amount, issue a certificate for the amount to the Collector and the Collector shall proceed to recover the same in the same manner as an arrear of land revenue.
...
(b) in any other case, be punishable with fine which may extend to two hundred rupees.
   ...
   (2) Whoever, being disqualified under this Act for holding or obtaining a conductor's licence, acts as a conductor of a stage carriage in a public place or applies for or obtains a conductor's licence or, not being entitled to have a conductor's licence issued to him free of endorsement, applies for or obtains a conductor's licence without disclosing the endorsements made on a conductor's licence previously held by him, shall be punishable with improsonment for a term which may extend to one month, or with fine which may extend to one hundred rupees, or with both, and any conductor's licence so obtained by him shall be of no effect.
      1[182A. Punishment for offences relating to construction and maintenance of vehicles.-Any person who contravenes the provisions of sub-section (3) of section 109, shall be punishable with a fine of five thousand rupees for any subsequent offence.]
...
1. Ins. by Act 54 of 1994, s. 54 (w.e.f. 14-11-1994).
...
1. Subs. by Act 54 of 1994, s. 55, for section 192 (w.e.f. 14-11-1994).
   ...
   194. Driving vehicle exceeding permissible weight.-1[(1) Whoever drivers a motor vehicle or causes or allows a motor vehicle to be driven in contravention of the provisions of section 113 or section 114 or section 115 shall be punishable with minimum fine of two thousand rupees and an additional amount of one thousand rupees per tonne of excess load, together with the liability to pay charges for off-loading of the excess load.]
...
(b) "director", in relation to a firm, means a partner in the firm.
   200. Composition of certain offences.-(1) Any offence whether committed before or after the commencement of this Act punishable under section 177, section 178, section 179, section 180, section 181, section 182, sub-section (1) or sub-section (2) of section 183, section 184, section 186,1[section 189,
sub-section (2) of section190]; section 191, section 192, section 194, section 196 or section 198 may either before or after the institution of the prosecution, be compounded by such officers or authorities and for such amount as the State Government may, by notification in the Official Gazette, specify in this behalf.
   ...
   201. Penalty for causing obstruction to free flow of traffic.-(1) Whoever keeps a disabled vehicle on any public place, in such a manner, so as to cause impediment to the free flow of traffic, shall be liable for penalty up to fifty rupees per hour, so long as it remains in that position:
   Provided that the vehicle involved in accidents shall be liable for penalty only from the time of completion of inspection formalities under the law.
      2[Provided further that where the vehicle is removed by a Government agency, towing charges shall be recovered from the vehicle owner or person in-charge of such vehicle.]
      3[(2) Penalties or towing charges under this section shall be recovered by such officer or authority as the State Government may, by notification in the Official Gazette, authorise.]
...
1. Subs. by Act 54 of 1994, s. 58, for "section 189" (w.e.f. 14-11-1994).
2. Ins. by s. 59, ibid. (w.e.f. 14-11-1994).
   ...
   203. Breath tests.-2[(1) A police officer in uniform or an officer of the Motor Vehicles Department, as may be authorised in this behalf by that Department, may require any person driving or attempting to drive a motor vehicle in a public place to provide one or more specimens of breath for breath test there or nearby, if such police officer or officer has any reasonable cause to suspect him of having committed an offence under section 185:
...
(3) The results of a laboratory test made in pursuance of this section shall be admissible in evidence.
   ...
   Provided that if any magistrate, police officer or other person authorised by the State Government in this behalf is, on an application made to him, satisfied that the licence cannot be, or has not been, returned

to the holder thereof before the date specified in the acknowledgment for any reason for which the holder is not responsible, the magistrate, police officer or other person, as the case may be, may extend the period of authorization to drive to such date as may be specified in the acknowledgment.
...
(a) may appear by pleader or in person; or
   ...
   (b) within fourteen days from the commission of the offence, a notice specifying the nature of the offence and the time and place where it is alleged to have been committed was served on or sent by

registered post to him or the person registered as the owner of the vehicle at the time of the commission of the offence, or
...
(See sections 116 and 119) TRAFFIC SIGNS
...
(3) Where the speed limit is, or is to be, imposed only on a certain class or classes of motor vehicle, the class or classes will be specified on the "definition plate". Where in addition to a general speed limit applicable to other motor vehicles a special speed limit is or is to be imposed on vehicles of a certain class or classes, the general speed limit will be specified on the disc and the special speed limit together with the class or classes of vehicle to which it applies, will be specified on the "definition plate".
...
(iii) Loss of Estate	-- Rs. 2,500/-
   ...
   (iv) Medical Expenses-Actual expenses incurred before death supported by bills/vouchers but not exceeding
...
1. Ins. by Act 54 of 1994, s. 64 (w.e.f. 14-11-1994).

   (ii) Medical Expenses-Actual expenses incurred supported by bills/vouchers but not exceeding as one time payment
...
(b) Spouse	-Rs. l/3rd of income of the
